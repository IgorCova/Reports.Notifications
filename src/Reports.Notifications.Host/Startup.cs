...
using Reports.Notifications.Host.Extensions;
using Reports.Notifications.Host.Configuration;
using Hangfire;
...
namespace Reports.Notifications.Host
{
    ...
    {
        private const string ServiceName = "Reports.Notifications.Host";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IDistributedLockProvider>(_ =>
                new PostgresDistributedSynchronizationProvider(settings.ReportsConnectionString)
            );
            #endregion
            ...
            #region Hangfire
            services.AddHangfire(x => x.UsePostgreSqlStorage(settings.HangfireConnectionString));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Reports.Notifications.Host v1"));
            }
